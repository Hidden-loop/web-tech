...
echo "a{ font-size: 20px; text-decoration:none; color: blue; margin-left:700px; margin-top:25px; padding-top:15px; text-align:center; justify-content:center; align-items:center; }";
echo "</style>";
echo "</head>";
echo "<body>";
...
if ($result->num_rows > 0) {
  ...
  echo "</table>";
        ...
        echo "<a href='edit.php?mobile=$mobile' class='button'>Edit</a><br>";
        echo "<a href='basic.html'>Go back?</a>";
